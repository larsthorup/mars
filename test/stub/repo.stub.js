...
function stub(options) {
    ...
    options.sandbox.stub(repo.user, 'findingByName', function (repo, name) {
        var users = [];
    ...
    options.sandbox.stub(repo.entry, 'findingLatest', function () {
        return Promise.resolve(options.entry);
    });

    options.sandbox.stub(repo.entry, 'findingById', function (id) {
